...
const service: ApiService = useMock ? new mockService.MockApiService() : new HttpApiService();

export const login = service.login.bind(service);
export const runWorkflow = service.runWorkflow.bind(service);